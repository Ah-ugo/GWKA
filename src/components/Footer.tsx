...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[10px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 flex items-center align-middle max-w-[160px]">
                  <Image
                ...
                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                  ...
                  <span>08036546953</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Admissions">
              <NavLink link="/ComingSoon" label="Admission Process" />
              <NavLink link="/ComingSoon" label="Event Calendar" />
              {/* <NavLink link="/#" label="User Flow" /> */}
              {/* <NavLink link="/#" label="User Strategy" /> */}
            </LinkGroup>
            <LinkGroup header="Sections">
              <NavLink link="/#" label="Nursery" />
              <NavLink link="/#" label="Primary" />
              <NavLink link="/#" label="Junior Secondary" />
              <NavLink link="/#" label="Senior Secondary" />
            </LinkGroup>
            <LinkGroup header="Quick Links">
              <NavLink link="/" label="Home" />
              <NavLink link="/ComingSoon" label="About Us" />
              <NavLink link="/ComingSoon" label="Contact Us" />
              <NavLink link="/ComingSoon" label="Download App" />
            </LinkGroup>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; 2024 Gratefulness Wonderland Kids Academy
                </p>
              </div>
            </div>
          </div>
